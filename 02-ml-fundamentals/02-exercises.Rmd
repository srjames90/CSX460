...
```{r}
# ... ggplot2
#Plots Fuel Economy as DV and EngDispl as IV with the median (our naive guess)
#superimposed 
...
# Plots 
#Similar to prior plot, except using our sample of 10 as our data
...
```{r}
#y and yhat are vectors, square vectors...sqrt and mean produces 1 value
...
```{r}
#Not sure why it was named fit.2010 when we are using 2011 data
#Spec doesn't specify which VarValve to use, but VarValveLift is below
#significance cutoff, so I didn't include it
fit.2011 <- lm(FE ~ EngDispl + NumCyl + VarValveTiming, data = cars2011)
#betas are our coefficients
